...
export const metadata: Metadata = {
  title: 'Privacy Policy | Parlay on Friends',
  description: 'Privacy Policy for Parlay on Friends - Learn how we collect, use, and protect your personal information.',
}
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div data-custom-class="body">
          ...
          <div style={{ lineHeight: 1.5 }}>
            ...
            <a data-custom-class="link" href="https://app.termly.io/notify/308ea1dd-adef-4b45-a03a-744a2c8fd082" rel="noopener noreferrer" target="_blank">
              <span style={{ color: 'rgb(0, 58, 250)', fontSize: '15px' }}>
          ...
          <div style={{ lineHeight: 1.5 }}>
            <span style={{ fontSize: '15px', color: 'rgb(89, 89, 89)' }}>
              <span data-custom-class="body_text">
                ...
                <span style={{ color: 'rgb(0, 58, 250)' }}>
                  <a href="https://stripe.com/privacy" target="_blank" data-custom-class="link">https://stripe.com/privacy</a>
                </span>.
              </span>
            </span>
          </div>
